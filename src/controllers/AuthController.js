...
module.exports = {
    ...
    signin: async (req, res) => {
        try {
            ...
            //Call signup api
            var [err, signIn] = await Helper.to(Accounts.singIn({
                email,
                password
            }));
    ...
    signup: async (req, res) => {
        try {
            ...
            const validationRules = [
                ...
                body('email').notEmpty().withMessage('Email is required').isEmail().withMessage('Not a valid email').escape(),
            ...
            //Call signup api
            var [err, signUp] = await Helper.to(Accounts.signUp({
                first_name,
                last_name,
                email,
                password,
    ...
    */
    ...
    tokenAuth: async function (req, res) {
        try {
            ...
            var [err, duser] = await Helper.to(Users.findOne({ user_id: user.id }));
